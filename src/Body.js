        ...
        return (
            <div>
                ...
                <div className="forth-line">
                    <div className="row">
                        <h3>ПОГОНЯЛО</h3>
                        <p>Небесные, Небесная машина</p>
                    </div>
                    <div className="row">
                        <h3>КОНЦЕПЦИЯ</h3>
                        <p>Большинство игроков "Урожайной" - жители Минского района</p>
                        <p>Команда представляет, как Урожайную, так и соседние с ней города и села Минского района - Леонтьевичи, Сеницу, Юбилейный, Скориничи, Михановичи, Гатово и др.</p>
                        <p>При этом в рядах ФК "Урожайная" были и легионеры. В частности, первый в истории Минской области футболист из Перу.</p>
                    </div>
                </div>
